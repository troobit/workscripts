...
tools: ['edit/createFile', 'edit/createDirectory', 'edit/editNotebook', 'edit/editFiles', 'search', 'new', 'runCommands', 'Microsoft Docs/*', 'Azure MCP/appconfig', 'Azure MCP/applens', 'Azure MCP/applicationinsights', 'Azure MCP/appservice', 'Azure MCP/azd', 'Azure MCP/azureterraformbestpractices', 'Azure MCP/bicepschema', 'Azure MCP/cloudarchitect', 'Azure MCP/communication', 'Azure MCP/confidentialledger', 'Azure MCP/deploy', 'Azure MCP/documentation', 'Azure MCP/eventgrid', 'Azure MCP/eventhubs', 'Azure MCP/extension_azqr', 'Azure MCP/functionapp', 'Azure MCP/get_bestpractices', 'Azure MCP/group_list', 'Azure MCP/keyvault', 'Azure MCP/kusto', 'Azure MCP/loadtesting', 'Azure MCP/managedlustre', 'Azure MCP/monitor', 'Azure MCP/mysql', 'Azure MCP/redis', 'Azure MCP/resourcehealth', 'Azure MCP/search', 'Azure MCP/storage', 'Azure MCP/subscription_list', 'azure/search', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions']
---
