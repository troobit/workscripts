...
- [ ] 1. Relocate PowerShell/ to powershell/ via git mv with space-free subdirs <!-- id:1r4styj -->
  - Preserve history: git log --follow traces a sample moved file
  - Do NOT touch macos/, specs/, nextup.md

- [ ] 2. Move general-win-use.txt under windows/ (or powershell/docs/) <!-- id:1r4styk -->

## Documentation

- [ ] 3. Add area READMEs for relocated content (powershell/, windows/) <!-- id:1r4styl -->
...
- [ ] 4. Rewrite root README.md as file tree + table of contents only <!-- id:1r4stym -->
